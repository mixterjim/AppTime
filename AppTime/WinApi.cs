...
public class WinApi
{
    ...
    public static extern int PostMessage(int hWnd,
    int msg, int wParam, int lParam);


    [DllImport("User32.DLL", EntryPoint = "SendMessageA")]
    public static extern int SendMessage(IntPtr hWnd,
    WindowsMessage msg, int wParam, int lParam);
    ...
    [DllImport("User32.DLL", EntryPoint = "SendMessageA")]
    public static extern int SendMessage(IntPtr hWnd,
    WindowsMessage msg, int wParam, StringBuilder lParam);

    [DllImport("User32.DLL", EntryPoint = "SendMessageA")]
    public static extern int SendMessage(IntPtr hWnd,
    WindowsMessage msg, int wParam, string lParam);
...
CONST RECT *lpRect // screen coordinates
    ...
    [DllImport("user32.dll")]
    public static extern int ShowWindow(IntPtr hwnd, EnumSW nCmdShow);
